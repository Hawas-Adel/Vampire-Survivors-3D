...
{
	public const string _Health = nameof(_Health);
	public const string _Health_Regen = nameof(_Health_Regen);
	public const string _Mana = nameof(_Mana);
	public const string _Mana_Regen = nameof(_Mana_Regen);

	public const string _Strength = nameof(_Strength);
	public const string _Dexterity = nameof(_Dexterity);
	...
	public const string _AOE_Size = nameof(_AOE_Size);
	...
	public const string _Critical_Chance = nameof(_Critical_Chance);
	public const string _Critical_Multiplier = nameof(_Critical_Multiplier);

	public const string _Life_Steal = nameof(_Life_Steal);
}
